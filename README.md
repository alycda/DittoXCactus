...
See [implementation-plan](_docs/plans/2026-05-21-001-feat-mesh-rag-stage-0-implementation-plan.md)
for the full plan, and [SEED.md](docs/SEED.md) for the thesis + holdout scenarios.
