...
// QueryScreen (two-tab Scaffold + MeshStatusWidget in AppBar) is defined in
// `lib/widgets/query_screen.dart` (U10). The boot sequence above hands off
// to it once `_BootPhase.ready` is reached.
